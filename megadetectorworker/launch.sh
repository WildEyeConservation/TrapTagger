...
for ((i=0;$((i<$NUMGPUS));i++)) do
  docker run -e AWS_ACCESS_KEY_ID -e AWS_SECRET_ACCESS_KEY -e REDIS_IP --hostname worker$i@$1 -e WORKER_NAME=$1 -e QUEUE -e WORKER_NUMBER=$i -e CUDA_VISIBLE_DEVICES=$i -v /home/ubuntu/wildcruweb/megadetectorworker:/code/megadetectorworker -v /home/ubuntu/wildcruweb/CameraTraps:/code/CameraTraps --gpus all --ipc=host --name megadetectorworker$i megadetector_worker celery -A megadetectorworker.megaDetector worker -Q $QUEUE --concurrency=1 -l info > worker$i.log 2>&1 &
