...
app = Celery('megaDetector', broker='redis://'+REDIS_IP,backend='redis://'+REDIS_IP,broker_transport_options={'visibility_timeout': 86400},result_expires=86400)
init=False
workername="default"
...
@app.task()
def infer(batch,sourceBucket,external):
    '''
