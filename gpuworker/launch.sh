...
for ((i=0;$((i<$NUMGPUS));i++)) do
  docker run -e AWS_ACCESS_KEY_ID -e AWS_SECRET_ACCESS_KEY -e REDIS_IP --hostname worker$i@$1 -e WORKER_NAME=$1 -e QUEUE -e WORKER_NUMBER=$i -e CUDA_VISIBLE_DEVICES=$i -e WBIA_DB_NAME -e WBIA_DB_SERVER -e WBIA_DIR -v /home/ubuntu/TrapTagger/gpuworker:/code/gpuworker -v /home/ubuntu/TrapTagger/CameraTraps/detection:/code/CameraTrapsdetection/ -v /home/ubuntu/TrapTagger/CameraTraps/data_management:/code/CameraTraps/data_management -v /home/ubuntu/TrapTagger/CameraTraps/visualization:/code/CameraTraps/visualization -v /home/ubuntu/TrapTagger/CameraTraps/ct_utils.py:/code/CameraTraps/ct_utils.py -v /home/ubuntu/TrapTagger/gpuworker/init.py:/code/ScarceNet/lib/models/__init__.py -v /home/ubuntu/TrapTagger/wildbook-ia/wbia:/code/gpuworker/wbia --gpus all --ipc=host --name gpuworker$i gpu_worker celery -A gpuworker.worker worker -Q $QUEUE -Ofair --concurrency=1 -l info > worker$i.log 2>&1 &
